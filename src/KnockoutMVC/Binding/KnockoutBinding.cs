namespace Microsoft.AspNetCore.Mvc.Knockout.Binding
{
	...
	public class KnockoutBinding <TModel> : KnockoutSubContext<TModel>, IHtmlContent
	{
		public KnockoutBinding(
		...
		{
			Items.Add
				(new KnockoutBindingStringItem("valueUpdate", Enum.GetName(typeof( KnockoutValueUpdateKind ), kind).ToLower()));
			return this;
		}
		...
		// *** Events ***
		protected virtual KnockoutBinding<TModel> Event(
			string eventName,
			string actionName,
		...
		private readonly Dictionary<string, KnockoutBingindComplexItem> complexItems =
			new Dictionary<string, KnockoutBingindComplexItem>();
